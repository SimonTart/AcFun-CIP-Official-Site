...
# ssh me_tencent 'export PATH=$PATH:/root/.nvm/versions/node/v10.14.2/bin/node && pm2 stop AcFun-CIP-OS && cd AcFun-CIP-OS && knex migrate:latest && pm2 start AcFun-CIP-OS'